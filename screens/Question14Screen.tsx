...
const Question14Screen = ({ navigation, route }) => {
    ...
    const handleNext = () => {
      ...
      if (updatedAnswers.length < 15) {
        navigation.navigate('Question15', { email, firstName, location, country, zipcode, gender, interests, bio, images, password, answers: updatedAnswers });
      } else {
    ...
    return (
      ...
      <Text style={styles.title}>What are your deal breakers in a relationship?</Text>
      <TextInput
        style={styles.input}
...
export default Question14Screen;
