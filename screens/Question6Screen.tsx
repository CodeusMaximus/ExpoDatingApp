...
const Question6Screen = ({ navigation, route }) => {
  ...
  const handleNext = () => {
    ...
    if (updatedAnswers.length < 15) {
      navigation.navigate('Question7', { email, firstName, location, country, zipcode, gender, interests, bio, images, password, answers: updatedAnswers });
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>How important is being employed to you in a relationship?</Text>
      <TextInput
        style={styles.input}
