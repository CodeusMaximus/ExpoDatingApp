...
const Question9Screen = ({ navigation, route }) => {
    ...
    const handleNext = () => {
      ...
      if (updatedAnswers.length < 15) {
        navigation.navigate('Question10', { email, firstName, location, country, zipcode, gender, interests, bio, images, password, answers: updatedAnswers });
      } else {
    ...
    return (
      ...
      <Text style={styles.title}>Would you date someone who is in considerable debt?</Text>
      <TextInput
        style={styles.input}
...
export default Question9Screen;
