...
const Question7Screen = ({ navigation, route }) => {
  ...
  const handleNext = () => {
    ...
    if (updatedAnswers.length < 15) {
      navigation.navigate('Question8', { age, email, firstName, location, city, state,  gender, interests, bio, images, password, answers: updatedAnswers });
    } else {
